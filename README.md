...
- 🐍 **Backend**: FastAPI, SQLAlchemy, PostgreSQL, Redis (планируется).
...
1.  🚀 **[SETUP.md](SETUP.md)** — Установка Backend, настройка БД PostgreSQL и запуск сервера.
...
- `/utils`: Утилиты шифрования, авторизации и валидации.
